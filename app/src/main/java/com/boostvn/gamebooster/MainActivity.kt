        ...
        Thread {
            ...
            runOnUiThread {
                ...
                try {
                    ...
                    hudIntent.putExtra("perf_mode", effectiveMode.name) // để tái kiểm tra giữa trận (v1.25) và tự khôi phục RAM booster dùng đúng chế độ, không đảo ngược lựa chọn người dùng
